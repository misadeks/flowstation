...
**Verdict: 🔴 GAP (HIGH).**
No maximum user count is enforced.  Motorola gates on
`M_MAXUSERSPERDYNPDCHAN`.

**Draft issue:** See §6 / Issue B.
...
| P5 | Max PDCH reservation count enforcement | 🔴 GAP | HIGH |
...
**Verdict counts:** CONFORM 4 · PARTIAL 5 · DIVERGE/GAP 2
